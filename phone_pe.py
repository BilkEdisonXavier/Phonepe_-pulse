...
if select == "Home":
    ...
    with col3:
        st.image(Image.open(r"C:\Users\User\Downloads\phonepe\download2.webp"),width= 600)
    ...
    with col6:
        st.image(Image.open(r"C:\Users\User\Downloads\phonepe\download3.webp"),width= 600)
