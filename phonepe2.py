...
aggre_insurance= pd.DataFrame(table3, columns=("States", "Years", "Quarter", "Transaction_type",
...
map_insurance= pd.DataFrame(table6, columns=("States", "Years", "Quarter", "District",
                                               "Transaction_count", "Transaction_amount"))
...
map_transaction= pd.DataFrame(table4, columns=("States", "Years", "Quarter", "District",
                                               "Transaction_count", "Transaction_amount"))
...
map_user= pd.DataFrame(table5, columns=("States", "Years", "Quarter", "District",
...
if select == "HOME":
    ...
    with col2:
        st.image(Image.open(r"C:\Users\User\Downloads\phonepe\phonepe-logo.jpg"),width= 600)
